...
export default class Toast {
  ...
  style = {
    ...
    toastStyle: {
      ...
      top: '50%',
      left: '50%',
      'min-width': calPxToREM(120),
      'max-width': calPxToREM(200),
      'min-height': calPxToREM(120),
      padding: calPxToREM(15),
      transform: 'translate(-50%, -50%)',
      'border-radius': calPxToREM(5),
      'text-align': 'center',
      'line-height': '1.6',
      color: '#FFFFFF',
    ...
    successStyle: {
      ...
      color: '#FFFFFF',
      'font-size': calPxToREM(55),
      'line-height': '1'
    },
    loadingStyle: {
      margin: `${calPxToREM(6)} auto`,
      width: calPxToREM(38),
      height: calPxToREM(38),
  ...
  create (options = {}) {
    ...
    this.toast.setAttribute('style', inlineStyle({
      ...
      ...(config.icon === 'none' ? {
        'min-height': '0',
        padding: `${calPxToREM(10)} ${calPxToREM(15)}`
      } : {})
    }))
